...
// require App::path('Vendor')[0] .'Instagram.php';
...
*/
class Instagram2Component extends Component {
  ...
  public function __construct($config) {
    if (is_array($config)) {
      ...
      $this->setApiKey(Configure::read('Instagram.client'));
      $this->setApiSecret(Configure::read('Instagram.secret'));
      $this->setApiCallback(Configure::read('Instagram.callback_url'));
  ...
  public function likeMedia($id) {    
    return $this->_makeCall('media/' . $id . '/likes', false, null, 'POST');
  }
