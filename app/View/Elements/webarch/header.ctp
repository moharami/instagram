...
<div class="header navbar navbar-inverse "> 
  ...
  <div class="navbar-inner">
    <div class="header-seperation"> 
      ...
      <a href="index.html">
        <?php 
            echo $this->Html->image('/webarch/img/logo.png', array('alt'=> 'altText','class'=>'logo'));
         ?>
        </a>
      <!-- END LOGO --> 
      ...
      <div class="pull-right"> 
        <div class="chat-toggler">  
                    ...
                    <div style="width:300px">
                          <div class="notification-messages info">
                                    <div class="user-profile">
                                        ...
                                        <?php 
                                        echo $this->Html->image('/webarch/img/profiles/d.jpg', array('alt'=> 'altText','width'=>'35','height'=>'35'));
                                         ?>
                                    </div>
                ...
                <div class="profile-pic"> 
                    <?php 
                                        echo $this->Html->image('/webarch/img/profiles/avatar_small.jpg', array('alt'=> 'altText','width'=>'35','height'=>'35'));
                                         ?>
                </div>                  
            </div>
         <ul class="nav quick-section ">
